...
\begin{frame}{Apport du \textsl{deep learning}}
    \begin{itemize}
        \item La profondeur du réseau neuronal permet de traiter certains aspects plus subtils du discours (parallèle avec la vision si le temps ?)
...
\begin{frame}{Procédure d'entraînement}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{contextual_utterances_training_fr.png}
